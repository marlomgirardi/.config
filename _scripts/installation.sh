...
# if exists brew; then
#   ######
#   # Force to be installed with brew to have smoother update
#   ######
...
# if ! has_app "iTerm"; then brew_cask_install iterm; fi
...
# # if ! has_app "zoom.us"; then brew_cask_install zoomus; fi
