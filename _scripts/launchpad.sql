...
-- Order
    ...
    UPDATE items SET ordering = 13 WHERE rowid = (SELECT item_id FROM apps WHERE title = 'RunJS');
    UPDATE items SET ordering = 14 WHERE rowid = (SELECT item_id FROM apps WHERE title = 'Slack');
    UPDATE items SET ordering = 15 WHERE rowid = (SELECT item_id FROM apps WHERE title = 'Skype');
    UPDATE items SET ordering = 16 WHERE rowid = (SELECT item_id FROM apps WHERE title = 'WhatsApp');
    UPDATE items SET ordering = 17 WHERE rowid = (SELECT item_id FROM apps WHERE title = 'Telegram');
    UPDATE items SET ordering = 18 WHERE rowid = (SELECT item_id FROM apps WHERE title = 'Franz');
    UPDATE items SET ordering = 19 WHERE rowid = (SELECT item_id FROM apps WHERE title = 'Spotify');
    UPDATE items SET ordering = 20 WHERE rowid = (SELECT item_id FROM apps WHERE title = 'Evernote');
    UPDATE items SET ordering = 21 WHERE rowid = (SELECT item_id FROM apps WHERE title = 'Notes');
    UPDATE items SET ordering = 22 WHERE rowid = (SELECT item_id FROM apps WHERE title = 'Kindle');
    UPDATE items SET ordering = 23 WHERE rowid = (SELECT item_id FROM apps WHERE title = 'Dashlane');
    UPDATE items SET ordering = 24 WHERE rowid = (SELECT item_id FROM apps WHERE title = 'Stremio');

    UPDATE items SET ordering = 35 WHERE rowid = (SELECT item_id FROM apps WHERE title = 'FaceTime');
    UPDATE items SET ordering = 36 WHERE rowid = (SELECT item_id FROM apps WHERE title = 'Messages');
    UPDATE items SET ordering = 37 WHERE rowid = (SELECT item_id FROM apps WHERE title = 'Photos');
    UPDATE items SET ordering = 38 WHERE rowid = (SELECT item_id FROM apps WHERE title = 'Pages');
    UPDATE items SET ordering = 39 WHERE rowid = (SELECT item_id FROM apps WHERE title = 'Numbers');
    UPDATE items SET ordering = 40 WHERE rowid = (SELECT item_id FROM apps WHERE title = 'Keynote');
    UPDATE items SET ordering = 41 WHERE rowid = (SELECT item_id FROM apps WHERE title = 'Grammarly');

    UPDATE items SET ordering = 43 WHERE rowid = (SELECT item_id FROM apps WHERE title = 'Lightshot Screenshot');
    UPDATE items SET ordering = 44 WHERE rowid = (SELECT item_id FROM apps WHERE title = 'GIF Brewery 3');
